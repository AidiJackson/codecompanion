...
class APIHealthChecker:
    ...
    def initialize_clients(self):
        ...
        try:
            ...
            if openai_key:
                ...
                self.health_status["openai"]["error"] = (
        ...
        try:
            ...
            if anthropic_key:
                ...
                self.health_status["anthropic"]["error"] = (
                    "API key not found in environment"
                )
        except Exception as e:
            self.health_status["anthropic"]["error"] = (
        ...
        try:
            ...
            if google_key:
                ...
                self.health_status["google"]["error"] = (
                    "API key not found in environment"
                )
        except Exception as e:
            self.health_status["google"]["error"] = (
    ...
    def get_working_client(self, service: str):
        ...
        if (
            service in self.clients
            and self.health_status[service]["status"] == "healthy"
        ):
