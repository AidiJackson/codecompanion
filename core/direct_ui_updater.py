...
class DirectUIUpdater:
    ...
    def update_status_direct(self, message: str, agent_type: str = "system") -> None:
        ...
        logger.info(
            f"DIRECT UI UPDATE: {current_time} - {message} | Agent: {agent_type}"
        )

    def add_agent_output_direct(
        self, agent: str, content: str, word_count: Optional[int] = None
    ) -> None:
    ...
    def add_artifact_direct(
        self, title: str, content: str, artifact_type: str = "analysis"
    ) -> None:
