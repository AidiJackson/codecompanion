...
def demo_vector_store():
    ...
    vector_store = VectorStore(
        db_path="memory/demo_vector_memory.db",
    ...
    sample_docs = [
        {
            ...
            "metadata": {"category": "programming", "language": "python", "topic": "overview"}
        },
        {
            "id": "doc2", 
        ...
        },
        {
            ...
            "metadata": {"category": "database", "type": "vector", "topic": "similarity_search"}
        },
        {
            "id": "doc5",
    ...
    for query in test_queries:
        ...
        if results:
            for i, (doc_id, score, metadata) in enumerate(results, 1):
                print(f"  {i}. {doc_id} (score: {score:.3f}) - {metadata.get('topic', 'N/A')}")
        else:
    ...
    if handles:
        print(f"📄 Document retrieval by handle:")
