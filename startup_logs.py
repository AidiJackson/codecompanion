...
def log_system_startup():
    ...
    try:
        ...
        if not any(models.values()):
            logger.warning("⚠️  No AI model API keys detected - system will have limited functionality")
...
def validate_critical_config():
    ...
    if settings.EVENT_BUS == "redis" and not settings.REDIS_URL:
        try:
            ...
            errors.append("Redis event bus selected but no REDIS_URL provided and localhost:6379 unreachable")
