...
class DatabaseManager:
    ...
    def update_artifact_quality(self, artifact_id: int, quality_score: float):
        ...
        try:
            ...
            conn.commit()
            logger.info(
                f"Updated quality score for artifact {artifact_id}: {quality_score}"
            )
    ...
    def update_agent_performance(
        self, model_name: str, task_type: str, success: bool, quality_score: float = 0.0
    ):
        ...
        try:
            ...
            if row:
                ...
                new_avg_quality = (
                    (avg_quality * total_executions) + quality_score
                ) / new_total
    ...
    def cleanup_old_data(self, days_to_keep: int = 30):
        ...
        try:
            ...
            conn.commit()
            logger.info(
                f"Cleaned up {deleted_events} events and {deleted_metrics} metrics"
            )
