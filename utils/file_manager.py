...
class FileManager:
    ...
    def create_project_structure(
        self, project_name: str, template_type: str = "Custom Project"
    ) -> Dict[str, Any]:
    ...
    def add_file(
        ...
        self._log_file_operation(
            "add_file", filepath, {"size": file_info["size"], "project": project_name}
        )
    ...
    def update_file(
        self, filepath: str, new_content: str, update_metadata: Dict[str, Any] = None
    ) -> Dict[str, Any]:
    ...
    def delete_file(self, filepath: str) -> bool:
        ...
        self._log_file_operation("delete_file", filepath, {"size": file_info["size"]})
    ...
    def _create_zip_archive(
        self, files: Dict[str, str], project_name: str = None
    ) -> bytes:
    ...
    def extract_archive(
        self, archive_data: bytes, project_name: str, format_type: str = "zip"
    ) -> Dict[str, Any]:
    ...
    def _extract_zip_archive(
        self, archive_data: bytes, project_name: str
    ) -> Dict[str, Any]:
        """Extract ZIP archive"""
        extracted_files = {}
        metadata = None
            ...
            with zipfile.ZipFile(io.BytesIO(archive_data), "r") as zip_file:
                for file_info in zip_file.filelist():
                    ...
                    self.add_file(
                        ...
                        content,
                        project_name,
                        {"extracted_from_archive": True, "original_filename": filename},
                    )
    ...
    def backup_project(
        self, project_name: str, backup_path: str = None
    ) -> Dict[str, Any]:
        ...
        if backup_path is None:
            ...
            backup_path = os.path.join(
                self.base_directory, f"{project_name}_backup_{timestamp}.zip"
            )
    ...
    def restore_project(
        self, backup_path: str, project_name: str = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.extract_archive(
                archive_data, project_name or "restored_project"
            )

            self._log_file_operation(
                "restore_project",
                project_name or "restored",
                {
                    "backup_path": backup_path,
    ...
    def analyze_project(self, project_name: str = None) -> Dict[str, Any]:
        ...
        for filepath, file_info in files.items():
            ...
            if "/" in filepath:
                ...
                analysis["directory_structure"][directory] = (
                    analysis["directory_structure"].get(directory, 0) + 1
                )

            # Language detection
            language = self._detect_language(filepath, file_info["content"])
            if language:
                analysis["language_breakdown"][language] = (
                    analysis["language_breakdown"].get(language, 0) + 1
                )
            ...
            analysis["largest_files"].append(
                {"filepath": filepath, "size": file_info["size"], "lines": lines}
            )
        ...
        analysis["code_to_documentation_ratio"] = analysis["code_metrics"][
            "code_files"
    ...
    def cleanup_old_files(self, days_old: int = 30, project_name: str = None):
        ...
        return {"files_removed": len(files_to_remove), "files_cleaned": files_to_remove}
...
"""
    ...
    def _is_configuration_file(self, filepath: str) -> bool:
        ...
        return (
            ...
            or any(config_name in name for config_name in config_names)
...
def add_project_file(
    filepath: str, content: str, project_name: str = None
) -> Dict[str, Any]:
